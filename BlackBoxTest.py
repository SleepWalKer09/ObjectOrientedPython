...
Prueba inputs o valida output

Unit Test: Prueba una a una las funciones del codigo

Integration Test: Prueba que todos los modulos funcionan entre si
"""
...
def suma(num1, num2):
    ...
    return num1 + num2
# Esta creacion del objeto crea automaticamente los testeos dentro del modulo de python
