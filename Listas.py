...
Cuando se modifica una lista pueden existir efectos secundarios en el codigo

Es posible iterar con ellas

Se pueden asignar indices y usar metodos de lista (append, pop, remove, insert, etc)
"""
